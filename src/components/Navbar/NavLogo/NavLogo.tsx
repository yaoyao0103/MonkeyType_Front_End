    ...
    return (
        <div className='NavLogo__outer'>
            <div className='NavLogo__logo'>
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{ isolation: 'isolate' }} viewBox="-680 -1030 300 180">
                    <g>
            ...
            <div className='NavLogo__text'>
                <div className='NavLogo__text-top'>monkey see</div>
                <div className='NavLogo__text-bottom'>monkeytype</div>
            </div>
        </div>
    )
}
